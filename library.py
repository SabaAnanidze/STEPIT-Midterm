...
def input_non_empty(userinp: str):
    while True:
...
def add_book_cnsl(manager: BookManager):
...
def view_books_cnsl(manager: BookManager):
...
def search_book_cnsl(manager: BookManager):
